...
export const APP_NAME = process.env.NEXT_PUBLIC_APP_NAME || "Schiceya Cal";
export const SUPPORT_MAIL_ADDRESS = process.env.NEXT_PUBLIC_SUPPORT_MAIL_ADDRESS || "support@schiceya.cal";
export const COMPANY_NAME = process.env.NEXT_PUBLIC_COMPANY_NAME || "Schiceya";
export const SENDER_ID = process.env.NEXT_PUBLIC_SENDER_ID || "Schiceya";
export const SENDER_NAME = process.env.NEXT_PUBLIC_SENDGRID_SENDER_NAME || "Schiceya Cal";
...
export const LOGO = "/schiceya-cal-wordmark.svg";
export const LOGO_DARK = "/schiceya-cal-wordmark.svg";
export const LOGO_ICON = "/schiceya-cal-icon.svg";
